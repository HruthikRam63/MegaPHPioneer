...
FOR %%x IN ("C:\Users\hruth\Downloads\MoodleWindowsInstaller-latest\server\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\hruth\Downloads\MoodleWindowsInstaller-latest\server\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\hruth\Downloads\MoodleWindowsInstaller-latest\server\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\hruth\Downloads\MoodleWindowsInstaller-latest\server\php\php.exe"
